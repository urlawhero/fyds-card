        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a href="https://wa.me/35797901102" className="flex items-center justify-center gap-2 py-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl transition-all text-green-400">
                <FaWhatsapp className="text-xl" /> Chat
              </a>
              <a href="https://foryoudigitalsolutions.com" className="flex items-center justify-center gap-2 py-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl transition-all text-blue-400">
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-black text-white selection:bg-purple-500/30">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* Put your photo as 'profile.jpg' in public folder. If you don't have one, delete this block */}
          ...
          <div className="w-full space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
               <a href="mailto:fydigitalsolutions@gmail.com" className="flex items-center justify-center gap-2 py-4 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl transition-all text-gray-300">
                <FaEnvelope /> Email
              </a>
